...
//            verify(eventRepository, times(1)).createEvent(any(Event.class));
//        }
//    }
//
////    @Test
...
////        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
////        Event event1 = new Event(1, "Music Festival", "Live performances by popular artists", "Join us for a day full of music, food, and fun!", "Central Park", sdf.parse("2023-07-10 18:00:00"), sdf.parse("2023-07-11 02:00:00"), "music_festival_poster.jpg", 50, "Festival", 2);
////        Event event2 = new Event(2, "Art Exhibition", "Discover the beauty of contemporary art", "Explore stunning artworks created by talented local artists.", "Gallery XYZ", sdf.parse("2023-07-12 10:00:00"), sdf.parse("2023-07-12 18:00:00"), "art_exhibition_poster.jpg", 10, "Exhibition", 2);
////        List<Event> events = Arrays.asList(event1, event2);
////
////        when(eventRepository.getAllEvents()).thenReturn(events);
////
...
////        assert(result.get(0).getEventId() == 1);
////        assert(result.get(1).getEventId() == 2);
////    }
